package org.lamisplus.modules.hts.extensions;
...
import org.lamisplus.modules.hts.domain.HtsDomain;
...
public class EntityScanConfiguration implements HibernatePackageConfigurer {
    ...
    public void configureHibernatePackage(HibernatePackageRegistry hibernatePackageRegistry) {
        hibernatePackageRegistry.addPackageToScan(HtsDomain.class, PatientDomain.class);
    }
