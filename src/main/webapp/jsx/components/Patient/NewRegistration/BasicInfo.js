...
const getSettingList =(newSetting)=>{

  let availableSetting = []
  let unAvailableSetting = []

  let currentSetting=["STI", "EMERGENCY", "INDEX", "INPATIENT", "PMTCT", "TB", "VCT", "MOBILE", "SNS", "OTHER"]


  newSetting.map((each, index)=>{



    currentSetting.map((value, i)=>{

      if(each.code.includes(value)  ){
       availableSetting.push(each)
   
     }else{

       unAvailableSetting.push(each)
          ...
          //   if(each.code.includes(currentSetting[i])  ){
          //     availableSetting.push(each)
  ...
  console.log("availableSetting", availableSetting)
  console.log("unAvailableSetting", unAvailableSetting)
...
let newSetting = [
  {
      "id": 1955,
      "codesetGroup": "COMMUNITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "Congregational setting",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_CONGREGATIONAL_SETTING",
      "archived": 0
  },
  {
      "id": 1964,
      ...
      "display": "CT",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_CT",
      "archived": 0
  },
  {
      "id": 1956,
      "codesetGroup": "COMMUNITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "Delivery homes",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_DELIVERY_HOMES",
      "archived": 0
  },
  {
      "id": 1959,
      ...
      "display": "Index",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_INDEX",
      "archived": 0
  },
  {
      "id": 1960,
      ...
      "display": "Others",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_OTHERS",
      "archived": 0
  },
  {
      "id": 1963,
      ...
      "display": "Outreach",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_OUTREACH",
      "archived": 0
  },
  {
      "id": 1962,
      ...
      "display": "OVC",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_OVC",
      "archived": 0
  },
  {
      "id": 1961,
      ...
      "display": "SNS",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_SNS",
      "archived": 0
  },
  {
      "id": 1965,
      "codesetGroup": "COMMUNITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "Standalone HTS",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_STANDALONE_HTS",
      "archived": 0
  },
  {
      "id": 1957,
      "codesetGroup": "COMMUNITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "TBA Orthodox",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_TBA_ORTHODOX",
      "archived": 0
  },
  {
      "id": 1958,
      ...
      "display": "TBA rt-HCW",
      "version": "1.0",
      "code": "COMMUNITY_HTS_TEST_SETTING_TBA_RT-HCW",
      "archived": 0
  }
]
...
let newSetting2 =[
  {
      ...
      "display": "ANC",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_ANC",
      "archived": 0
  },
  {
      "id": 1948,
      ...
      "display": "Blood Bank",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_BLOOD_BANK",
      "archived": 0
  },
  {
      "id": 1941,
      ...
      "display": "CT",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_CT",
      "archived": 0
  },
  {
      "id": 1947,
      ...
      "display": "Emergency",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_EMERGENCY",
      "archived": 0
  },
  {
      "id": 1943,
      ...
      "display": "FP",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_FP",
      "archived": 0
  },
  {
      "id": 1946,
      ...
      "display": "Index",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_INDEX",
      "archived": 0
  },
  {
      "id": 1938,
      ...
      "display": "L&D",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_L&D",
      "archived": 0
  },
  {
      "id": 1950,
      ...
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_MALNUTRITION",
      "archived": 0
  },
  {
      "id": 1954,
      ...
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_OTHERS_(SPECIFY)",
      "archived": 0
  },
  {
      "id": 1949,
      ...
      "display": "Pediatric",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_PEDIATRIC",
      "archived": 0
  },
  {
      "id": 1939,
      "codesetGroup": "FACILITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "Post Natal Ward/Breastfeeding",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_POST_NATAL_WARD_BREASTFEEDING",
      "archived": 0
  },
  {
      "id": 1951,
      "codesetGroup": "FACILITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "PrEP Testing",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_PREP_TESTING",
      "archived": 0
  },
  {
      "id": 1937,
      ...
      "display": "Retesting",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_RETESTING",
      "archived": 0
  },
  {
      "id": 1945,
      ...
      "display": "SNS",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_SNS",
      "archived": 0
  },
  {
      "id": 1952,
  ...
  },
  {
      ...
      "display": "Standalone HTS",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_STANDALONE_HTS",
      "archived": 0
  },
  {
      "id": 1944,
      ...
      "display": "STI",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_STI",
      "archived": 0
  },
  {
      "id": 1942,
      ...
      "display": "TB",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_TB",
      "archived": 0
  },
  {
      "id": 1940,
      "codesetGroup": "FACILITY_HTS_TEST_SETTING",
      "language": "en",
      "display": "Ward/Inpatient",
      "version": "1.0",
      "code": "FACILITY_HTS_TEST_SETTING_WARD_INPATIENT",
      "archived": 0
  }
]
