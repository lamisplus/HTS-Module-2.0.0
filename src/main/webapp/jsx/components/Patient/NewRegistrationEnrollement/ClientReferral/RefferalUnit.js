...
const RefferralUnit = (props) => {
 ...
 const getProvinceWithWithId = (id) => {
  ...
  const getReceivingProvinceWithWithId = (name) => {
    console.log(states);
    let selectedState = states.filter((each, index) => {
  ...
  const getStateByCountryId = () => {
    ...
    getAllStateByCountryId()
      .then((res) => {
        ...
        setStates(res);
        if (props.formInfo.receivingFacilityStateName) {
          let selectedState = res.filter((each, index) => {
            return (
          ...
          getAllProvinces(selectedState[0].id)
            .then((res) => {
  ...
  const loadLgaReceivingFacilities = (id) => {
    axios
      .get(`${baseUrl}organisation-units/parent-organisation-units/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
                ...
                <div className="form-group mb-3 col-md-4">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        if (e.target.value !== "") {
                          let filterState = statesOfTheReceivingFacility.filter(
                            (st) => {
                  ...
                  <div className="form-group mb-3 col-md-4">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          if (e.target.value !== "") {
                            let filterlga = lgasOfTheReceivingFacility.filter(
                              (lg) => {
                                return lg.name === e.target.value;
                              }
                            );

                            console.log(filterlga);
                      ...
                      >
                        ...
                        {console.log(
                          "receivng lga payload",
                          payload.receivingFacilityLgaName
                        )}
                        {console.log(
                          "receivng lga",
                          lgasOfTheReceivingFacility
                        )}
