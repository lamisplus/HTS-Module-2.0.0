...
const RefferralUnit = (props) => {
  ...
  //        useEffect(() => {
  // filterSelectedLGAFromState()

  //        }, [payload.receivingStateFacility]);
  //Get list of State
  ...
  const filterSelectedLGAFromState = async (id) => {
    let ans = states.filter((each, index) => {
      return (
        each.name.toLowerCase() === payload.receivingStateFacility.toLowerCase()
      );
    });

    console.log("NKJFJKFDKKJFJK", ans);
                        ...
                        onChange={(e) => {
                          if (e.target.value !== "") {
                            ...
                            setPayload((prevPayload) => ({
                              ...prevPayload,
                              receivingStateFacility: e.target.value,
                            }));
                          }
