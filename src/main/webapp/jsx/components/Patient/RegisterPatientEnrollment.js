...
import IndexingContactTracing from './NewRegistrationEnrollement/IndexingContactTracing'
                    ...
                    <Link to={"/"} >
                        ...
                        <Menu  size='large'  vertical  style={{backgroundColor:"#014D88"}}>
                            ...
                            <Menu.Item
                                ...
                                style={{backgroundColor:activeItem === 'others' ? '#000': ""}}
                                disabled={activeItem !== 'others' ? true : false}
                            >               
                                <span style={{color:'#fff'}}> Request {"&"} Result Form</span>
                                {completed.includes('others') && (
                                    <Icon name='check' color='green' />
                                )}
